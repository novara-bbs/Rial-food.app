...
const noChipTokenDrift = {
  ...
  message:
    'Chip-shaped surfaces (rounded-full + px-N) must use text-micro (10px), not text-caption. See chip-primitives.test.ts and ADR-013.',
};
...
const noChipTokenDriftTpl = {
  ...
  message:
    'Chip-shaped surfaces (rounded-full + px-N) must use text-micro (10px), not text-caption. See ADR-013.',
};
