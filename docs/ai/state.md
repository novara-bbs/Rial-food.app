...
Last updated: **2026-05-01** — `[1.5.175]` Home resilience: 3-action ErrorBoundary + i18n + RecipeImage primitive + defensive log handler + macros sweep.

## Release snapshot
- **Branch**: `main`, synced con `rial-food/main` (CI green S39; S40–S52 queued).
- **This session (2026-05-01, S52 — home resilience [1.5.175])**:
