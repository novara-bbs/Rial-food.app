...
Last updated: 2026-04-19 (docs pass `[1.5.39]` staged — popup/sheet/modal inventory + decision framework via ADR-009 V3 + playbook §4.4.b/§4.4.c + NEW-SCREEN-CHECKLIST §6c rewrite; PR 6.5 shipped at `4e3840b`)

## Release snapshot
- Root branch: `main`, HEAD `4e3840b` (PR 6.5 Bevel selective migrations, in sync with `rial-food/main`). Docs pass `[1.5.39]` staged on working tree (4 files: playbook §4.4.b/§4.4.c, ADR-009 V3 addendum, NEW-SCREEN-CHECKLIST §6c, CHANGELOG).
