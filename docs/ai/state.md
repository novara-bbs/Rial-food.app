...
Last updated: **2026-04-30** — `[1.5.173]` Onboarding typography normalization + step 4+5 merge (training → activity) + DoneStep declutter.

## Release snapshot
- **Branch**: `main`, synced con `rial-food/main` (CI green S39; S40–S51 queued).
- **This session (2026-04-30, onboarding polish PRs 1-4 + refactor + GDPR fix + UI normalize)**:
