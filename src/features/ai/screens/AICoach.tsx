            ...
            <div className="flex flex-wrap gap-2 pb-2">
              {quickActions.map((action, idx) => (
                <button type="button"
                  ...
                  className="inline-flex items-center gap-1.5 min-h-[22px] px-2.5 bg-surface-container-low border border-outline-variant/30 rounded-full text-pico font-medium normal-case tracking-normal text-on-surface-variant hover:text-primary hover:border-primary/50 transition-colors"
                >
                  {action.icon}
                  {action.label}
                </button>
