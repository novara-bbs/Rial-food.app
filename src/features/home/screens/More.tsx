...
export default function More({ navigateTo }: { navigateTo: (screen: string) => void }) {
  ...
  const menuItems = [
    ...
    { id: 'weekly-check-in', label: t.more.reflectionHistory, icon: CalendarCheck, desc: t.more.reflectionHistoryDesc, screen: 'weekly-check-in', color: 'text-brand-secondary' },
