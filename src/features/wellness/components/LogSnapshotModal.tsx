...
export default function LogSnapshotModal({
  ...
  const handleSave = () => {
    ...
    // Only include measurements if any value is set
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md max-h-[90vh] overflow-y-auto bg-surface-container-low border border-outline-variant/20" showCloseButton={false}>
        <DialogHeader>
          <DialogTitle className="font-headline font-bold text-lg uppercase tracking-widest text-tertiary">
            {initialSnapshot ? (p.editSnapshot ?? 'Editar snapshot') : (p.logSnapshot ?? 'Registrar snapshot')}
          </DialogTitle>
        </DialogHeader>
        ...
        <div className="space-y-4 py-2">
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-surface-container-highest border border-outline-variant/20 rounded-sm py-2 px-3 text-sm text-tertiary focus:outline-none focus:border-primary disabled:opacity-60"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-surface-container-highest border border-outline-variant/20 rounded-sm py-2 px-3 text-sm text-tertiary focus:outline-none focus:border-primary"
            />
          </div>
                ...
                {([
                  ...
                  <div key={key}>
                    ...
                    <input
                      ...
                      className="w-full bg-surface-container-highest border border-outline-variant/20 rounded-sm py-1.5 px-2.5 text-sm text-tertiary focus:outline-none focus:border-primary"
                    />
                  </div>
                ))}
              </div>
