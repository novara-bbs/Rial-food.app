              ...
              .map((s, i) => (
                ...
                >
                  ...
                  <button type="button"
                    ...
                    className="inline-flex items-center min-h-7 px-3 py-1 rounded-full text-micro font-medium normal-case tracking-normal text-brand-secondary bg-brand-secondary/10 hover:bg-brand-secondary/20 transition-colors"
                  >
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex flex-col items-end gap-2 shrink-0">
                      ...
                      <button type="button"
                        ...
                        className={`inline-flex items-center gap-1 min-h-7 px-3 py-1 rounded-full text-micro font-medium normal-case tracking-normal transition-colors ${statusCfg.color}`}
