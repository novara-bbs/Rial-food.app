      ...
      <div className="bg-surface-container-low rounded-sm border border-outline-variant/20 overflow-hidden">
          ...
          <div className="px-6 pb-4">
            <div className="bg-background rounded-sm border border-primary/30 p-3 flex items-center gap-3 relative">
              ...
              <div>
                ...
                <span className="font-label text-micro tracking-widest text-on-surface-variant block mt-0.5">{attachedRecipe.cal} kcal · {attachedRecipe.pro}g P</span>
              </div>
            </div>
          </div>
        )}
        ...
        <div className="border-t border-outline-variant/10 p-4 bg-surface-container-highest flex items-center gap-4">
          ...
          <button type="button"
            ...
            className={`w-11 h-11 rounded-full flex items-center justify-center transition-colors ${attachedRecipe ? 'bg-primary text-on-primary' : 'bg-surface-container-low text-on-surface-variant hover:text-primary hover:bg-primary/10'}`}
          ...
          <button type="button"
            ...
            className={`w-11 h-11 rounded-full flex items-center justify-center transition-colors ${attachPerformance ? 'bg-primary text-on-primary' : 'bg-surface-container-low text-on-surface-variant hover:text-primary hover:bg-primary/10'}`}
          >
            <Activity className="w-5 h-5" />
          </button>
          <div className="flex-1" />
          <span className="font-label text-caption font-bold tracking-widest text-outline-variant uppercase">{content.length} / 500</span>
        </div>
      </div>
