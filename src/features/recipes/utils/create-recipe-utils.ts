/**
 * Utility functions shared by CreateRecipe and its sub-components.
 * Extracted in Sprint 32 [1.5.146] to reduce CreateRecipe.tsx below 400 lines.
 */
import type { RecipeIngredient, FoodTag } from '../../../types';
