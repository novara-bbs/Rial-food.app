    ...
    >
      {chips.map(chip => (
        <button
          ...
          className="flex items-center gap-1.5 px-4 py-2 rounded-full bg-primary/10 text-primary border border-primary/25 text-micro font-label font-bold uppercase tracking-widest transition-colors hover:bg-primary/20"
        >
