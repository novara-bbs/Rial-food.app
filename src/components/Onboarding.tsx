...
import { ArrowLeft, Dumbbell, Flame, Scale, Heart, Users, ChevronRight, Check } from 'lucide-react';
...
export default function Onboarding({ isOpen, onClose, onComplete }: {
  ...
  const targets = calculateDailyTargets(data.weight, data.height, data.age, data.sex, data.activity, (data.goal || 'maintain') as any);
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-background/95 backdrop-blur-md p-4 animate-in fade-in duration-300">
      <div className="bg-surface-container w-full max-w-lg max-h-[90vh] rounded-2xl border border-outline-variant/20 shadow-2xl overflow-hidden flex flex-col animate-in zoom-in-95 duration-300">
        ...
        <div className="p-5 border-b border-outline-variant/10 shrink-0">
          <div className="flex items-center justify-between mb-3">
            ...
            <span className="font-mono text-xs text-on-surface-variant">{step}/5</span>
          </div>
          {/* Progress bar */}
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-5">
            ...
            <>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {activities.map(a => (
                      <button key={a.id} onClick={() => setData(d => ({ ...d, activity: a.id as any }))}
          ...
          {step === 5 && (
            <div className="text-center py-6 space-y-6">
              ...
              <div className="bg-surface-container-low border border-outline-variant/20 rounded-2xl p-5 text-left space-y-3">
