...
const SHAPE =
  'inline-flex items-center gap-1.5 min-h-7 px-3 py-1 rounded-full border shadow-elev-1 ' +
  'text-micro font-medium normal-case tracking-normal whitespace-nowrap ' +
