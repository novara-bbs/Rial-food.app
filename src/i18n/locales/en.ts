...
const en: Translations = {
  ...
  weeklyReview: {
    ...
    subtitle: 'Your week in data',
    macroAdherence: 'Nutritional adherence',
    adherencePct: '% of target',
    topInsights: 'Top correlations',
    noInsights: 'Log at least 7 days to see correlations',
    bestDay: 'Best day',
    worstDay: 'Tough day',
    planNextWeek: 'Plan next week',
    avgRealFeel: 'Avg Real Feel',
    daysLogged: 'days logged',
    noData: 'No data this week',
    noDataDesc: 'Log your Real Feel and meals to see your summary',
    calories: 'Calories',
    protein: 'Protein',
    carbs: 'Carbs',
    fats: 'Fats',
